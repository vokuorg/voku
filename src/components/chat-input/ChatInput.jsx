...
function ChatInput({ placeholder }) {
  return (
    <div className="flex p-3 border-t-2 border-gray-600">
      ...
      <button className='inline-flex items-center w-10 h-10 px-2 py-1 font-medium transform rotate-90 bg-green-500 rounded-lg focus:outline-none'>
          <svg className="inline-block w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">

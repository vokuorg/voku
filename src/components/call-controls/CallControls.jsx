...
function CallControls() {
  ...
  return (
    <div className="relative flex content-center justify-center space-x-3">
      { /* Volume Button */ }
      <Button classNames="h-9 my-auto bg-dark-tertiary hover:bg-gray text-white absolute left-3">
      ...
      { /* Expand Button */ }
      <Button classNames="h-9 my-auto bg-dark-tertiary hover:bg-gray text-white absolute right-3">
